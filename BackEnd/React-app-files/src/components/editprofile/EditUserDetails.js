                ...
                <div className="card-body p-5">
                    <form onSubmit={updateUserData}>
                        ...
                        <div className="row form-group">
                            ...
                            <div className="col-12 col-md-9">
                                <div className='row'>
                                    <input className="col-md-1 form-control" type="text" placeholder="+ 91" disabled={true} required />
                                    <input className="col-md-11 form-control" type="text" id="contact" name="contact-input" placeholder={number.slice(3, number.length)} ref={formNumber} />
                                </div>
                                {/* <input type="text" id="contact" name="contact-input" placeholder={number} ref={formNumber} className="form-control" /> */}
                            </div>
                        </div>
                        <div className="row form-group">
                            <div className="col col-md-3">
                        ...
                        <div className="card-footer-edit-profile">
                            <div>
